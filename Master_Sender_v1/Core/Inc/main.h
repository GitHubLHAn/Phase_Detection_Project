...
#define ADC1_IN0_PA_Pin GPIO_PIN_0
#define ADC1_IN0_PA_GPIO_Port GPIOA
#define ADC1_IN1_PB_Pin GPIO_PIN_1
#define ADC1_IN1_PB_GPIO_Port GPIOA
#define ADC1_IN2_PC_Pin GPIO_PIN_2
#define ADC1_IN2_PC_GPIO_Port GPIOA
...
#define DETECT_ZC_PA_Pin GPIO_PIN_15
#define DETECT_ZC_PA_GPIO_Port GPIOA
#define DETECT_ZC_PB_Pin GPIO_PIN_3
#define DETECT_ZC_PB_GPIO_Port GPIOB
...
#define LED_STATUS_MASTER_2_Pin GPIO_PIN_8
#define LED_STATUS_MASTER_2_GPIO_Port GPIOB
#define LED_STATUS_MASTER_1_Pin GPIO_PIN_9
#define LED_STATUS_MASTER_1_GPIO_Port GPIOB
